  ...
  return (
    <main className="flex flex-col gap-5">
      <div className="flex flex-col px-8 py-8 justify-center">
        <Image src={`/logos/RAF-logo.svg`} alt="Ross Alan Ford logo" width={100} height={100}/>
        <Suspense fallback={<Loading/>}>
          <div className="flex flex-col z-50 bg-primary rounded-md p-1 justify-between ">
            <div className="bg-secondary rounded-md p-4">
              <div className="flex flex-col bg-foreground shadow-xl rounded-sm py-8 px-6 gap-2">
                ...
                <h2 className="text-[4vw] text-background lg:text-2xl">A Full-Stack Developer with a background in Operations Management</h2>
              </div>
            </div>
