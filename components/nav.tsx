    ...
    return(
        <nav className="flex fixed z-50 md:justify-center top-0 w-full">
            <div className="flex flex-col-reverse md:flex-row flex-grow justify-end">
                ...
                <div ref={Navref} className={`flex transition mx-auto md:mx-0 bg-foreground md:block  ${navbar ? 'fixed top-0 flex-col min-h-content items-center w-full h-full scale-100 delay-50 duration-300 ease-in-out' : 'scale-0 md:scale-100 ease-out'}`}>
