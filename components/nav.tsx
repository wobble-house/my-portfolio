            ...
            <div className="flex flex-col-reverse md:flex-row flex-grow justify-end">
                ...
                <div ref={Navref} className={`flex transition mx-auto md:mx-0 bg-foreground md:block  ${navbar ? 'fixed top-0 flex-col min-h-content items-center w-full h-full scale-100 ease-in-out' : 'hidden scale-0 md:scale-100 ease-out'}`}>
                    <ul className="text-center flex flex-col md:flex-row text-accent md:border-b-4 md:border-x-4 border-primary md:rounded-b-md md:items-end">
                        ...
                        <Link href={'/'} className={`${pathname == '/' ? 'bg-primary rounded-md md:rounded-b-md' : ''} flex flex-col items-center gap-1 text-[8px] md:bg-foreground hover:bg-primary hover:bg-opacity-25 hover:scale-110 py-1 px-4 hover:text-white transition-all ease-in-out drop-shadow-xl`} onClick={handleClose}><HomeNavIcon height={30} width={30} className={`${pathname == '/' ? 'animate-pulse transition-all ease-in-out drop-shadow-xl': ''}`}/>HOME</Link>
                        <Link href={'/about'} className={`${pathname == '/about' ? 'bg-primary rounded-md md:rounded-b-md' : ''} flex flex-col items-center gap-1 text-[8px] md:bg-foreground  hover:bg-primary hover:bg-opacity-25 hover:scale-110 py-1 px-4 hover:text-white transition-all ease-in-out drop-shadow-xl`} onClick={handleClose}><AboutNavIcon height={30} width={30} className={`${pathname == '/about' ? 'animate-pulse transition-all ease-in-out drop-shadow-xl': ''}`}/>ABOUT</Link>
                        <Link href={'/portfolio'} className={`${pathname == '/portfolio' ? 'bg-primary rounded-md md:rounded-b-md' : ''} flex flex-col items-center gap-1 text-[8px] md:bg-foreground  hover:bg-primary hover:bg-opacity-25 hover:scale-110 py-1 px-4 hover:text-white transition-all ease-in-out drop-shadow-xl`} onClick={handleClose}><PortfolioNavIcon height={30} width={30} className={`${pathname == '/portfolio' ? 'animate-pulse transition-all ease-in-out drop-shadow-xl': ''}`}/>PORTFOLIO</Link>
                        <Link href={'/stories'} className={`${pathname == '/stories' ? 'bg-primary rounded-md md:rounded-b-md' : ''} flex flex-col items-center gap-1 text-[8px] md:bg-foreground  hover:bg-primary hover:bg-opacity-25 hover:scale-110 py-1 px-4 hover:text-white transition-all ease-in-out drop-shadow-xl`} onClick={handleClose}><StoriesNavIcon height={30} width={30} className={`${pathname == '/stories' ? 'animate-pulse transition-all ease-in-out drop-shadow-xl': ''}`}/>STORIES</Link>
                        <Link href={'/contact'} className={`${pathname == '/contact' ? 'bg-primary rounded-md md:rounded-b-md' : ''} flex flex-col items-center gap-1 text-[8px] md:bg-foreground  hover:bg-primary hover:bg-opacity-25 hover:scale-110 py-1 px-4 hover:text-white transition-all ease-in-out drop-shadow-xl`} onClick={handleClose}><ContactNavIcon height={30} width={30} className={`${pathname == '/contact' ? 'animate-pulse transition-all ease-in-out drop-shadow-xl': ''}`}/>CONTACT</Link>
                    </ul>
                </div>
            </div>
        </nav>
