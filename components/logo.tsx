...
<div className={`flex relative ${additionalClassName}`}>
    <div className={`${mobileOnly != null ? (mobileOnly == true ? "flex md:hidden" : "hidden md:flex") : containerClassName } z-30 justify-center items-center ${isStatic ? '' : 'animate-logo-spin'}`}>
        <Image src={'/images/SVG/leafring.svg'} alt="outer leaf ring" width={180 * scaleMultiplier} height={180 * scaleMultiplier} className=" slow drop-shadow-4xl"/>
        <Image src={'/images/SVG/leafring.svg'} alt="inner leaf ring" width={120 * scaleMultiplier} height={120 * scaleMultiplier} className="absolute drop-shadow-4xl medium"/>
