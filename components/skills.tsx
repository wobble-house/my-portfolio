                ...
                <div className="flex content-center justify-center bg-rosspurple dark:bg-rossdarkpurple w-full h-full relative shadow-3xl">
                    ...
                    title="JavaScript" className="flex bg-rosspurple dark:bg-rossdarkpurple h-[60px] w-[60px] justify-center content-center hover:scale-105 items-center">
                            <FontAwesomeIcon icon={faJs} size="2x"/>
                                ...
                                <div title="TypeScript" className="flex bg-rosspurple dark:bg-rossdarkpurple h-[60px] w-[60px] p-4 justify-center content-center hover:scale-105 items-center">
                            ...
                            />
                                ...
                                <div title="Html5" className="flex bg-rosspurple  dark:bg-rossdarkpurple h-[60px] w-[60px] justify-center content-center hover:scale-105 items-center">
                                <FontAwesomeIcon icon={faHtml5} size="2x"/>
                                </div>
                                <div title="CSS3" className="flex bg-rosspurple dark:bg-rossdarkpurple h-[60px] w-[60px] justify-center content-center hover:scale-105 items-center">
    ...
    return(
            ...
            <div className="flex w-[120px] h-[120px]">
                <div className="flex content-center justify-center bg-rosspurple dark:bg-rossdarkpurple w-full h-full relative shadow-3xl">
                    <div className="flex content-center justify-center bg-rossblue dark:bg-rossdarkblue w-full h-full relative -ml-4 -mt-2">
                        <div className="grid grid-cols-2 content-evenly relative gap-1 -ml-4 -mt-4 mr-2 mb-2">
                                <div title="React" className="flex bg-rosspurple dark:bg-rossdarkpurple h-[60px] w-[60px] justify-center content-center hover:scale-105 items-center">
                                <FontAwesomeIcon icon={faReact} size="2x"/>
                                </div> 
                                <div title="Nextjs" className="flex bg-rosspurple dark:bg-rossdarkpurple h-[60px] w-[60px] justify-center content-center hover:scale-105 items-center">
                            ...
                            />
                                ...
                                <div title="Docker" className="flex bg-rosspurple dark:bg-rossdarkpurple h-[60px] w-[60px] justify-center content-center hover:scale-105 items-center">
                                <FontAwesomeIcon icon={faDocker} size="2x"/>
                                </div>
                                <div title="Python" className="flex bg-rosspurple dark:bg-rossdarkpurple h-[60px] w-[60px] justify-center content-center hover:scale-105 items-center">
